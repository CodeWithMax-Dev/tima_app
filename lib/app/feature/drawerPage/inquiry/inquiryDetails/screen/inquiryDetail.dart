...
import 'package:tima_app/app/feature/drawerPage/inquiry/inquiryDetails/controller/inquiryDetailController.dart';
import 'package:tima_app/app/feature/visit/visitDetails/visitDetail.dart';
import 'package:tima_app/app/router/routeParams/inquiryDetailParams.dart';
                              ...
                              ? GestureDetector(
                                onTap: () {
                                  VisitDeatil(
                                    visitDetailScreenParams:
                                        VisitDetailScreenParams(
                                          indexlistno: getEnqList[index].id,
                                          name: getEnqList[index].personName,
                                        ),
                                  );
                                  // GoRouter.of(context).goNamed(
                                  //     routerConst.visitDetailScreen,
